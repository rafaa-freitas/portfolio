        ...
        <div className="flex gap-8 justify-center flex-wrap">
          <a href="https://www.linkedin.com/in/rafaafreitas/" target="_blank">
            <div className={'social-media-link-container'}>
              ...
              <div className="flex justify-start items-center">
                <h6 className={'social-media-link'}>Linkedin</h6>
                <ArrowExternalLink />
              </div>
            </div>
          </a>
          ...
          <a href="https://github.com/rafaa-freitas" target="_blank">
            <div className={'social-media-link-container'}>
              ...
              <div className="flex justify-start items-center">
                <h6 className={'social-media-link'}>Github</h6>
                <ArrowExternalLink />
              </div>
            </div>
          </a>
          ...
          <a href="mailto:rafael.freitasfa@gmail.com">
            <div className={'social-media-link-container'}>
              ...
              <AtSignIcon />
              <div className="flex justify-start items-center">
                <h6 className={'social-media-link'}>Email</h6>
                <ArrowExternalLink />
              </div>
            </div>
          </a>
          ...
          <a href="https://wa.me/5521976902000" target="_blank">
            <div className={'social-media-link-container'}>
              ...
              <WhatsAppIcon />
              <div className="flex justify-start items-center">
                <h6 className={'social-media-link'}>WhatsApp</h6>
                <ArrowExternalLink />
              </div>
            </div>
          </a>
          ...
          <a href={cv} target="_blank">
            <div className={'social-media-link-container'}>
              ...
              <ResumeIcon />
              <div className="flex justify-start items-center">
                <h6 className={'social-media-link'}>Resume</h6>
                <ArrowExternalLink />
              </div>
            </div>
          </a>
